...
async function cargarLibros(){
    ...
    for (let libro of libros){
        ...
        let libroHtml = '<tr><td>'+libro.tipo+'</td><td data-toggle="tooltip" data-placement="top" title="'+libro.descripcion+'">'+libro.nombre+'</td><td>'+libro.categoria+'</td><td>'+libro.seccion+'</td><td>'+libro.autor+'</td><td>tamaño</td><td>'+libro.fecha+'</td><td>'+botonEditar+' '+botonEliminar+'</td></tr>'
